...
<table width="100%" cellpadding="5" cellspacing="0">
	...
	<tr  align="center"  class='${balance.currentQuantity < balance.drug.reorderQty ?" reorder " : ""}${varStatus.index % 2 == 0 ? "oddRow" : "evenRow" }' >
		...
		<td><a href="#" onclick="STOCKBALLANCE.detailSubStoreDrugExpiry('${balance.drug.id}', '${balance.formulation.id}');" title="Detail all transactions of this drug">${balance.drug.name}</a></td>
