...
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code='inventory.purchaseItem.add'/>" onclick="ACT.go('itemPurchaseOrderForGeneralStore.form');"/>
<br /><br />

<form method="get"  id="form">
<table >
	<tr>
		<td><spring:message code="inventory.purchaseItem.name"/></td>
		<td>
...
<br />
<span class="boxHeader"><spring:message code="inventory.purchaseItem.list"/></span>
<div class="box">
<table width="100%" cellpadding="5" cellspacing="0">
	<tr>
	<th>S.No</th>
	<th><spring:message code="inventory.purchaseItem.name"/></th>
	<th><spring:message code="inventory.purchaseItem.createdOn"/></th>
	</tr>
	<c:choose>
	...
	<tr class='${varStatus.index % 2 == 0 ? "oddRow" : "evenRow" } '>
		...
		<td> <a href="#" title="Detail indent" onclick="INDENT.detailItemIndent('${ purchase.id}');">${purchase.name}</a> </td>	
