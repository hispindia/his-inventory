...
<form method="post" class="box" id="itemCategory">
<table>
	<tr>
...
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code="general.cancel"/>" onclick="ACT.go('itemCategoryList.form');">
</form>
